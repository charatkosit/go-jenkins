...
#copy new
cp /home/ec2-user/temp/all-script/aws-back-prod/script/*.* /home/ec2-user/script/
cp /home/ec2-user/temp/all-script/aws-back-prod/docker-mysql-pma/*.* /home/ec2-user/docker-mysql-pma/
#chmod
